<div id="comments">
			...
			<h4><?php $this->commentsNum(_t('当前暂无留言'), _t('仅有一条留言'), _t('已有 %d 条留言')); ?> &raquo;</h4>
			...
			<h4 id="response"><?php _e('添加新留言'); ?> &raquo;</h4>
			<form method="post" action="<?php $this->commentUrl() ?>" id="comment_form">
				...
				<p><input type="submit" value="<?php _e('提交留言'); ?>" class="submit" /></p>
			</form>
            </div>
            <?php else: ?>
            <h4><?php _e('留言已关闭'); ?></h4>
